                            ...
                            <tbody>
                                <tr >
                                    <td className='subHeadingImage'>
                                        <img width='200vmin'alt='Part 1 White Cross'src={whiteCross}></img>
                                    </td>
                    ...
                    <td>
                        <table className='solutionSubHeading'>
                            <tbody>
                                <tr >
                                    <td className='subHeadingImage'>
                                        <img width='200vmin'alt='Part 2 White Corners'src={whiteCorners}></img>
                                    </td>
                                    <td className='subHeadingText'>
                    ...
                    <td>
                        <table className='solutionSubHeading'>
                            <tbody>
                                <tr >
                                    <td className='subHeadingImage'>
                                        <img width='200vmin'alt='Part 3 Middle Edges'src={middleEdges}></img>
                                    </td>
                                    <td className='subHeadingText'>
                    ...
                    <td>
                        <table className='solutionSubHeading'>
                            <tbody>
                                <tr >
                                    <td className='subHeadingImage'>
                                        <img width='200vmin'alt='Part 4 Yellow Cross'src={yellowCross}></img>
                                    </td>
                                    <td className='subHeadingText'>
                    ...
                    <td>
                        <table className='solutionSubHeading'>
                            <tbody>
                                <tr >
                                    <td className='subHeadingImage'>
                                        <img width='150vmin'alt='Part 5 Yellow Corners'src={yellowCorners}></img>
                                    </td>
                                    <td className='subHeadingText'>
